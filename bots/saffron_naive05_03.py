...
- one early game gunship
- early game gunships attack FIRST
- non-early game gunships attack FIRST and STRONG by ratio of 2:1 
- many more bomber spawns
NOTES
- as it turns out, even on a graph as dense as hilbert, bombers still just always perform worse. 
- ^ hmm,,, unless rushes? though those seem to usually be midgame
